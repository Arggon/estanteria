...
- [x] `status <libro> --rating N` sin `--set` falla con mensaje claro (o aplica el rating a un libro ya leído, decidido y documentado en FORMAT.md)
- [x] test table-driven del caso
